...
__MODULE__ = "ᴀꜱꜱɪꜱᴛᴀɴᴛ"
__HELP__ = """
- `.sᴇᴛᴅᴘ`: Rᴇᴘʟʏ ᴛᴏ ᴀ ᴘʜᴏᴛᴏ ᴀɴᴅ ᴜsᴇ ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ ᴛᴏ sᴇᴛ ɪᴛ ᴀs ᴛʜᴇ ᴘʀᴏғɪᴇ ᴘɪᴄᴛᴜʀᴇ ᴏғ ᴀ ᴜsᴇʀʙᴏᴛ ᴀᴄᴄᴏᴜɴᴛs.
- `.sᴇᴛʙɪᴏ [ᴛᴇxᴛ]`: Sᴇᴛ ᴛʜᴇ ʙɪᴏ ᴏғ ᴀ ᴜsᴇʀʙᴏᴛ ᴀᴄᴄᴏᴜɴᴛs.
- `.sᴇᴛɴᴀᴍᴇ [ᴛᴇxᴛ]`: Sᴇᴛ ᴛʜᴇ ғɪʀsᴛ ɴᴀᴍᴇ ᴏғ ᴀ ᴜsᴇʀʙᴏᴛ ᴀᴄᴄᴏᴜɴᴛs.
- `.ᴅᴇʟᴅᴘ`: Dᴇᴇᴛᴇ ᴛʜᴇ ᴄᴜʀʀᴇɴᴛ ᴘʀᴏғɪᴇ ᴘɪᴄᴛᴜʀᴇ ᴏғ ᴀ ᴜsᴇʀʙᴏᴛ ᴀᴄᴄᴏᴜɴᴛs.
- `.ᴅᴇʟᴀʟʟᴅᴘ`: Dᴇʟᴇᴛᴇ ᴀ ᴘʀᴏғɪᴇ ᴘɪᴄᴛᴜʀᴇs ᴇxᴄᴇᴘᴛ ᴛʜᴇ ᴄᴜʀʀᴇɴᴛ ᴏɴᴇ ᴏғ ᴀ ᴜsᴇʀʙᴏᴛ ᴀᴄᴄᴏᴜɴᴛs.
"""
