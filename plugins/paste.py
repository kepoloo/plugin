...
Tʜɪs ᴄᴏᴍᴍᴀɴᴅ ᴀʟʟᴏᴡs ᴜsᴇʀs ᴛᴏ ᴘᴀsᴛᴇ ᴛᴇxᴛ ᴏʀ ᴛᴇxᴛ ғɪʟᴇs ᴛᴏ ᴀɴ ᴏɴʟɪɴᴇ sᴇʀᴠɪᴄᴇ ᴀɴᴅ ɢᴇɴᴇʀᴀᴛᴇ Cᴀʀʙᴏɴ ɪᴍᴀɢᴇs ғʀᴏᴍ ᴛʜᴇ ᴄᴏɴᴛᴇɴᴛ.

Fᴇᴀᴛᴜʀᴇs:
- Rᴇᴘʟʏ ᴛᴏ ᴀ ᴛᴇxᴛ ᴍᴇssᴀɢᴇ ᴏʀ ᴀ ᴛᴇxᴛ ғɪʟᴇ ᴛᴏ ᴘᴀsᴛᴇ ᴛʜᴇ ᴄᴏɴᴛᴇɴᴛ ᴛᴏ ᴀɴ ᴏɴʟɪɴᴇ sᴇʀᴠɪᴄᴇ ᴀɴᴅ ɢᴇɴᴇʀᴀᴛᴇ ᴀ Cᴀʀʙᴏɴ ɪᴍᴀɢᴇ.
- Sᴜᴘᴘᴏʀᴛs ᴘᴀsᴛɪɴɢ ʙᴏᴛʜ ᴘᴀɪɴ ᴛᴇxᴛ ᴀɴᴅ ᴛᴇxᴛ ғɪᴇs.
- Aᴜᴛᴏᴍᴀᴛɪᴄʟʏ sᴘʟɪᴛs ʟᴀʀɢᴇ ᴛᴇxᴛ ғɪᴇs ɪɴᴛᴏ ᴍᴜʟᴛɪᴘʟᴇ ᴘᴀɢᴇs ɪғ ɴᴇᴇᴅᴇᴅ.
- Uᴘʟᴏᴀᴅs ᴛʜᴇ ɢᴇɴᴇʀᴀᴛᴇᴅ Cᴀʀʙᴏɴ ɪᴍᴀɢᴇs ᴀs ʀᴇᴘʟɪᴇs ᴛᴏ ᴛʜᴇ ᴏʀɪɢɪɴᴀʟ ᴍᴇssᴀɢᴇ.
- Dɪsᴘʟᴀʏs ᴀ ᴘʀᴏᴄᴇssɪɴɢ ᴍᴇssᴀɢᴇ ᴡʜʟɪᴇ ᴘᴀsᴛɪɴɢ ᴀɴᴅ ᴜᴘʟᴏᴀᴅɪɴɢ ᴛʜᴇ ᴄᴏɴᴛᴇɴᴛ.

Cᴏᴍᴍᴀɴᴅs:
- /paste: Rᴇᴘʟʏ ᴛᴏ ᴀ ᴛᴇxᴛ ᴍᴇssᴀɢᴇ ᴏʀ ᴀ ᴛᴇxᴛ ғɪʟᴇ ᴛᴏ ɢᴇɴᴇʀᴀᴛᴇ Cᴀʀʙᴏɴ ɪᴍᴀɢᴇs ғʀᴏᴍ ᴛʜᴇ ᴄᴏɴᴛᴇɴᴛ.

Nᴏᴛᴇ: Oɴʟʏ ᴛᴇxᴛ ғɪʟᴇs sᴍᴀʟᴇʀ ᴛʜᴀɴ 1MB ᴄᴀɴ ʙᴇ ᴘᴀsᴛᴇᴅ. Uɴsᴜᴘᴘᴏʀᴛᴇᴅ ғɪʟᴇ ᴛʏᴘᴇs ᴡɪ ᴘʀᴏᴍᴘᴛ ᴀ ᴍᴇssᴀɢᴇ ɪɴᴅɪᴄᴀᴛɪɴɢ ᴛʜᴀᴛ ᴏɴʏ ᴛᴇxᴛ ғɪʟᴇs ᴄᴀɴ ʙᴇ ᴘᴀsᴛᴇᴅ.
"""
