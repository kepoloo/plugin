...
Tʜɪs ᴍᴏᴅᴜʟᴇ ᴀʟʟᴏᴡs ᴛʜᴇ ᴏᴡɴᴇʀ ᴛᴏ ᴄᴏᴘʏ ᴍᴇssᴀɢᴇs ғʀᴏᴍ ᴏɴᴇ ᴄʜᴀᴛ ᴛᴏ ᴀɴᴏᴛʜᴇʀ.

Cᴏᴍᴍᴀɴᴅs:
- /post: Rᴇᴘʟɪᴇs ᴛᴏ ᴀ ᴍᴇssᴀɢᴇ ᴛᴏ ᴄᴏᴘʏ ɪᴛ ᴛᴏ ᴀ ᴘʀᴇᴅᴇғɪɴᴇᴅ ᴅᴇsᴛɪɴᴀᴛɪᴏɴ ɢʀᴏᴜᴘ.

Nᴏᴛᴇ:
- Oɴʟʏ ᴛʜᴇ ᴏᴡɴᴇʀ ᴏғ ᴛʜᴇ ʙᴏᴛ ᴄᴀɴ ᴜsᴇ ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ.
- Rᴇᴘʟᴀᴄᴇ ᴛʜᴇ `ᴅᴇsᴛɪɴᴀᴛɪᴏɴ_ɢʀᴏᴜᴘ_ɪᴅ` ᴠᴀʀɪᴀʙʟᴇ ᴡɪᴛʜ ᴛʜᴇ ᴅᴇsɪʀᴇᴅ ᴅᴇsᴛɪɴᴀᴛɪᴏɴ ɢʀᴏᴜᴘ ID.
"""
