...
ᴄᴏᴍᴍᴀɴᴅ: /ᴄᴇᴋʙᴏᴛ
**ᴅᴇsᴄʀɪᴘᴛɪᴏɴ:**
ᴄʜᴇᴄᴋs ᴛʜᴇ ᴏɴʟɪɴᴇ sᴛᴀᴛᴜs ᴏғ ᴀ sᴘᴇᴄɪғɪᴇᴅ ʙᴏᴛ ʙʏ sᴇɴᴅɪɴɢ ɪᴛ ᴀ /sᴛᴀʀᴛ ᴍᴇssᴀɢᴇ.
...
- ᴅɪsᴘʟᴀʏs ᴛʜᴇ ʙᴏᴛ's sᴛᴀᴛᴜs ᴀs ᴇɪᴛʜᴇʀ ᴏɴɪɴᴇ ᴏʀ ᴏғғʟɪɴᴇ.

**ᴇxᴀᴍᴘʟᴇs:**
- /ᴄᴇᴋʙᴏᴛ @YᴏᴜʀBᴏᴛUsᴇʀɴᴀᴍᴇ: ᴄʜᴇᴄᴋs ɪғ @ʏᴏᴜʀʙᴏᴛᴜsᴇʀɴᴀᴍᴇ ɪs ᴏɴʟɪɴᴇ ᴏʀ ᴏғғʟɪɴᴇ.

**ɴᴏᴛᴇs:**
- ᴛʜᴇ ʙᴏᴛ ᴜsᴇʀɴᴀᴍᴇ ᴍᴜsᴛ ʙᴇ ᴘʀᴏᴠɪᴅᴇᴅ ᴀs ᴀɴ ᴀʀɢᴜᴍᴇɴᴛ.
- ᴛʜᴇ ᴄᴏᴍᴍᴀɴᴅ ᴅɪsᴘʟᴀʏ ᴀɴ ᴇʀʀᴏʀ ᴍᴇssᴀɢᴇ ɪғ ᴛʜᴇ ᴜsᴇʀɴᴀᴍᴇ ɪs ɪɴᴄᴏʀʀᴇᴄᴛ ᴏʀ ɪғ ᴛʜᴇʀᴇ ᴀʀᴇ ɪᴍɪᴛᴀᴛɪᴏɴs.

**ᴏᴜᴛᴘᴜᴛ:**
- ᴅɪsᴘʟᴀʏs ᴛʜᴇ ʙᴏᴛ's ᴍᴇɴᴛɪᴏɴ ᴀɴᴅ ɪᴛs ᴏɴʟɪɴᴇ sᴛᴀᴛᴜs.
