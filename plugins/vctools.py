...
**ᴅᴇsᴄʀɪᴘᴛɪᴏɴ:**
ᴄᴀᴄᴜʟᴀᴛᴇs ᴛʜᴇ ʀᴇsᴜʟᴛ ᴏғ ᴀ ᴍᴀᴛʜᴇᴍᴀᴛɪᴄᴀ ᴇxᴘʀᴇssɪᴏɴ.
...
- ʀᴇᴛᴜʀɴs ᴛʜᴇ ʀᴇsᴜᴛ ᴏғ ᴛʜᴇ ᴇxᴘʀᴇssɪᴏɴ.
- ᴅɪsᴘʟᴀʏs "ɪɴᴠᴀʟɪᴅ ᴇxᴘʀᴇssɪᴏɴ" ɪғ ᴛʜᴇ ᴇxᴘʀᴇssɪᴏɴ ɪs ɴᴏᴛ ᴠᴀʟɪᴅ.

ɢᴏᴏɢʟᴇ sᴇᴀʀᴄʜ ᴄᴏᴍᴍᴀɴᴅ ʜᴇʟᴘ

**Dᴇsᴄʀɪᴘᴛɪᴏɴ:**
sᴇᴀʀᴄʜᴇs ɢᴏᴏɢʟᴇ ᴀɴᴅ ᴅɪsᴘʟᴀʏs sᴇᴀʀᴄʜ ʀᴇsᴜᴛs.

**ᴜsᴀɢᴇ:**
/spg [ᴏ̨ᴜᴇʀʏ]

**ᴅᴇᴛᴀɪʟs:**
- sᴇᴀʀᴄʜᴇs ɢᴏᴏɢʟᴇ ғᴏʀ ᴛʜᴇ sᴘᴇᴄɪғɪᴇᴅ ᴏ̨ᴜᴇʀʏ.
- ᴅɪsᴘʟᴀʏs sᴇᴀʀᴄʜ ʀᴇsᴜʟᴛs ᴡɪᴛʜ ᴛɪᴛᴇs ᴀɴᴅ ʟɪɴᴋs.
- sᴜᴘᴘᴏʀᴛs ᴘᴀɢɪɴᴀᴛɪᴏɴ ᴡɪᴛʜ ɴᴇxᴛ ʙᴜᴛᴛᴏɴ ᴛᴏ ᴠɪᴇᴡ ᴍᴏʀᴇ ʀᴇsᴜʟᴛs.
"""
