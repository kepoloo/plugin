...
ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ ᴀᴏᴡs ᴜsᴇʀs ᴛᴏ sᴇᴛ ᴀɴ AFK (Aᴡᴀʏ Fʀᴏᴍ Kᴇʏʙᴏᴀʀᴅ) sᴛᴀᴛᴜs. Wʜᴇɴ ᴀ ᴜsᴇʀ sᴇᴛs AFK, ᴛʜᴇɪʀ sᴛᴀᴛᴜs ʙᴇ ᴅɪsᴘʟᴀʏᴇᴅ ᴡʜᴇɴᴇᴠᴇʀ sᴏᴍᴇᴏɴᴇ ᴍᴇɴᴛɪᴏɴs ᴛʜᴇᴍ ᴏʀ sᴇɴᴅs ᴀ ᴍᴇssᴀɢᴇ ɪɴ ᴀ ᴘʀɪᴠᴀᴛᴇ ᴄʜᴀᴛ.

ғᴇᴀᴛᴜʀᴇs:
- sᴇᴛ AFK sᴛᴀᴛᴜs ᴡɪᴛʜ ᴏᴘᴛɪᴏɴᴀʟ ʀᴇᴀsᴏɴ ᴀɴᴅ ᴍᴇᴅɪᴀ (ᴀɴɪᴍᴀᴛɪᴏɴ, ᴘʜᴏᴛᴏ).
- ᴅɪsᴘʟᴀʏ AFK sᴛᴀᴛᴜs ᴡʜᴇɴ ᴍᴇɴᴛɪᴏɴᴇᴅ ɪɴ ᴀ ɢʀᴏᴜᴘ ᴏʀ ᴘʀɪᴠᴀᴛᴇ ᴄʜᴀᴛ.
- ᴀᴜᴛᴏᴍᴀᴛɪᴄʟʏ ʀᴇᴍᴏᴠᴇ AFK sᴛᴀᴛᴜs ᴜᴘᴏɴ ᴜsᴇʀ's ʀᴇᴛᴜʀɴ.
- sᴜᴘᴘᴏʀᴛs ᴠᴀʀɪᴏᴜs ᴛʏᴘᴇs ᴏғ AFK ᴍᴇssᴀɢᴇs: ᴛᴇxᴛ, ᴛᴇxᴛ ᴡɪᴛʜ ʀᴇᴀsᴏɴ, ᴀɴɪᴍᴀᴛɪᴏɴ, ᴀɴᴅ ᴘʜᴏᴛᴏ.

ᴄᴏᴍᴍᴀɴᴅs:
- /ᴀғᴋ: sᴇᴛ AFK sᴛᴀᴛᴜs. ᴏᴘᴛɪᴏɴᴀʟ, ᴘʀᴏᴠɪᴅᴇ ᴀ ʀᴇᴀsᴏɴ ᴏʀ ʀᴇᴘʏ ᴡɪᴛʜ ᴍᴇᴅɪᴀ (ᴀɴɪᴍᴀᴛɪᴏɴ, ᴘʜᴏᴛᴏ).
- /ʙʀʙ: sᴀᴍᴇ ᴀs /ᴀғᴋ ᴄᴏᴍᴍᴀɴᴅ.

ɴᴏᴛᴇ: ᴡʜᴇɴ sᴇᴛ ᴀs AFK, ᴛʜᴇ ᴜsᴇʀ's sᴛᴀᴛᴜs ᴡɪ ʙᴇ ᴅɪsᴘʟᴀʏᴇᴅ ᴡʜᴇɴᴇᴠᴇʀ ᴛʜᴇʏ ᴀʀᴇ ᴍᴇɴᴛɪᴏɴᴇᴅ ᴏʀ ʀᴇᴄᴇɪᴠᴇ ᴀ ᴍᴇssᴀɢᴇ ɪɴ ᴀ ᴘʀɪᴠᴀᴛᴇ ᴄʜᴀᴛ. AFK sᴛᴀᴛᴜs ᴡɪ ʙᴇ ᴀᴜᴛᴏᴍᴀᴛɪᴄʟʏ ʀᴇᴍᴏᴠᴇᴅ ᴜᴘᴏɴ ᴜsᴇʀ's ʀᴇᴛᴜʀɴ.
"""
