...
Tʜɪs ᴄᴏᴍᴍᴀɴᴅ ᴀᴏᴡs ᴜsᴇʀs ᴛᴏ sᴇᴛ ᴀɴ AFK (Aᴡᴀʏ Fʀᴏᴍ Kᴇʏʙᴏᴀʀᴅ) sᴛᴀᴛᴜs. Wʜᴇɴ ᴀ ᴜsᴇʀ sᴇᴛs AFK, ᴛʜᴇɪʀ sᴛᴀᴛᴜs ʙᴇ ᴅɪsᴘʟᴀʏᴇᴅ ᴡʜᴇɴᴇᴠᴇʀ sᴏᴍᴇᴏɴᴇ ᴍᴇɴᴛɪᴏɴs ᴛʜᴇᴍ ᴏʀ sᴇɴᴅs ᴀ ᴍᴇssᴀɢᴇ ɪɴ ᴀ ᴘʀɪᴠᴀᴛᴇ ᴄʜᴀᴛ.

Fᴇᴀᴛᴜʀᴇs:
- Sᴇᴛ AFK sᴛᴀᴛᴜs ᴡɪᴛʜ ᴏᴘᴛɪᴏɴᴀʟ ʀᴇᴀsᴏɴ ᴀɴᴅ ᴍᴇᴅɪᴀ (ᴀɴɪᴍᴀᴛɪᴏɴ, ᴘʜᴏᴛᴏ).
- Dɪsᴘʟᴀʏ AFK sᴛᴀᴛᴜs ᴡʜᴇɴ ᴍᴇɴᴛɪᴏɴᴇᴅ ɪɴ ᴀ ɢʀᴏᴜᴘ ᴏʀ ᴘʀɪᴠᴀᴛᴇ ᴄʜᴀᴛ.
- Aᴜᴛᴏᴍᴀᴛɪᴄʟʏ ʀᴇᴍᴏᴠᴇ AFK sᴛᴀᴛᴜs ᴜᴘᴏɴ ᴜsᴇʀ's ʀᴇᴛᴜʀɴ.
- Sᴜᴘᴘᴏʀᴛs ᴠᴀʀɪᴏᴜs ᴛʏᴘᴇs ᴏғ AFK ᴍᴇssᴀɢᴇs: ᴛᴇxᴛ, ᴛᴇxᴛ ᴡɪᴛʜ ʀᴇᴀsᴏɴ, ᴀɴɪᴍᴀᴛɪᴏɴ, ᴀɴᴅ ᴘʜᴏᴛᴏ.

Cᴏᴍᴍᴀɴᴅs:
- /afk: Sᴇᴛ AFK sᴛᴀᴛᴜs. Oᴘᴛɪᴏɴᴀʟ, ᴘʀᴏᴠɪᴅᴇ ᴀ ʀᴇᴀsᴏɴ ᴏʀ ʀᴇᴘʏ ᴡɪᴛʜ ᴍᴇᴅɪᴀ (ᴀɴɪᴍᴀᴛɪᴏɴ, ᴘʜᴏᴛᴏ).
- /brb: sᴀᴍᴇ ᴀs /ᴀғᴋ ᴄᴏᴍᴍᴀɴᴅ.

Nᴏᴛᴇ: Wʜᴇɴ sᴇᴛ ᴀs AFK, ᴛʜᴇ ᴜsᴇʀ's sᴛᴀᴛᴜs ᴡɪ ʙᴇ ᴅɪsᴘʟᴀʏᴇᴅ ᴡʜᴇɴᴇᴠᴇʀ ᴛʜᴇʏ ᴀʀᴇ ᴍᴇɴᴛɪᴏɴᴇᴅ ᴏʀ ʀᴇᴄᴇɪᴠᴇ ᴀ ᴍᴇssᴀɢᴇ ɪɴ ᴀ ᴘʀɪᴠᴀᴛᴇ ᴄʜᴀᴛ. AFK sᴛᴀᴛᴜs ᴡɪ ʙᴇ ᴀᴜᴛᴏᴍᴀᴛɪᴄʟʏ ʀᴇᴍᴏᴠᴇᴅ ᴜᴘᴏɴ ᴜsᴇʀ's ʀᴇᴛᴜʀɴ.
"""
