...
Tʜɪs ᴍᴏᴅᴜʟᴇ ᴄᴏɴᴛᴀɪɴs ᴄᴏᴍᴍᴀɴᴅs ʀᴇᴀᴛᴇᴅ ᴛᴏ ᴅᴏᴡɴᴏᴀᴅɪɴɢ sᴏɴɢs ᴀɴᴅ Iɴsᴛᴀɢʀᴀᴍ ʀᴇᴇs.

**Aᴠᴀɪᴀʙᴇ Cᴏᴍᴍᴀɴᴅs:**

- `/song`: Dᴏᴡɴᴏᴀᴅs ᴀ sᴏɴɢ ʙᴀsᴇᴅ ᴏɴ ᴛʜᴇ ᴘʀᴏᴠɪᴅᴇᴅ ǫᴜᴇʀʏ.
- `/ig`: Dᴏᴡɴᴏᴀᴅs ᴀɴ Iɴsᴛᴀɢʀᴀᴍ ʀᴇᴇ ʙᴀsᴇᴅ ᴏɴ ᴛʜᴇ ᴘʀᴏᴠɪᴅᴇᴅ ɪɴᴋ.
- `/reel`: Dᴏᴡɴᴏᴀᴅs ᴀɴ Iɴsᴛᴀɢʀᴀᴍ ʀᴇᴇ ʙᴀsᴇᴅ ᴏɴ ᴛʜᴇ ᴘʀᴏᴠɪᴅᴇᴅ ɪɴᴋ.

**Nᴏᴛᴇ:**
- Tᴏ ᴅᴏᴡɴʟᴏᴀᴅ ᴀɴ Iɴsᴛᴀɢʀᴀᴍ ʀᴇᴇʟ, ᴘʀᴏᴠɪᴅᴇ ᴀ ᴠᴀɪᴅ Iɴsᴛᴀɢʀᴀᴍ ʀᴇᴇʟ URL ᴜsɪɴɢ ᴛʜᴇ `/ɪɢ` ᴏʀ `/ʀᴇᴇʟ` ᴄᴏᴍᴍᴀɴᴅ.
- Tʜᴇ ʙᴏᴛ ᴡɪ ʜᴀɴᴅʟᴇ sᴘᴀᴍᴍɪɴɢ ʙʏ ɪᴍɪᴛɪɴɢ ᴛʜᴇ ɴᴜᴍʙᴇʀ ᴏғ ᴄᴏᴍᴍᴀɴᴅs ᴘᴇʀ ᴜsᴇʀ ᴡɪᴛʜɪɴ ᴀ sᴘᴇᴄɪғɪᴄ ᴛɪᴍᴇ ᴡɪɴᴅᴏᴡ.
"""
