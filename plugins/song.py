...
ᴛʜɪs ᴍᴏᴅᴜʟᴇ ᴄᴏɴᴛᴀɪɴs ᴄᴏᴍᴍᴀɴᴅs ʀᴇᴀᴛᴇᴅ ᴛᴏ ᴅᴏᴡɴᴏᴀᴅɪɴɢ sᴏɴɢs ᴀɴᴅ ɪɴsᴛᴀɢʀᴀᴍ ʀᴇᴇʟs.

**ᴀᴠᴀɪʟᴀʙʟᴇ ᴄᴏᴍᴍᴀɴᴅs:**

- `/song`: Dᴏᴡɴʟᴏᴀᴅs ᴀ sᴏɴɢ ʙᴀsᴇᴅ ᴏɴ ᴛʜᴇ ᴘʀᴏᴠɪᴅᴇᴅ ᴏ̨ᴜᴇʀʏ.
- `/ig`: ᴅᴏᴡɴʟᴏᴀᴅs ᴀɴ ɪɴsᴛᴀɢʀᴀᴍ ʀᴇᴇʟs ʙᴀsᴇᴅ ᴏɴ ᴛʜᴇ ᴘʀᴏᴠɪᴅᴇᴅ ʟɪɴᴋ.
- `/reel`: Dᴏᴡɴᴏᴀᴅs ᴀɴ Iɴsᴛᴀɢʀᴀᴍ ʀᴇᴇ ʙᴀsᴇᴅ ᴏɴ ᴛʜᴇ ᴘʀᴏᴠɪᴅᴇᴅ ʟɪɴᴋ.

**ɴᴏᴛᴇ:**
- ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ ᴀɴ ɪɴsᴛᴀɢʀᴀᴍ ʀᴇᴇʟs, ᴘʀᴏᴠɪᴅᴇ ᴀ ᴠᴀɪᴅ ɪɴsᴛᴀɢʀᴀᴍ ʀᴇᴇʟ URL ᴜsɪɴɢ ᴛʜᴇ `/ɪɢ` ᴏʀ `/ʀᴇᴇʟ` ᴄᴏᴍᴍᴀɴᴅ.
- ᴛʜᴇ ʙᴏᴛ ᴡɪ ʜᴀɴᴅʟᴇ sᴘᴀᴍᴍɪɴɢ ʙʏ ɪᴍɪᴛɪɴɢ ᴛʜᴇ ɴᴜᴍʙᴇʀ ᴏғ ᴄᴏᴍᴍᴀɴᴅs ᴘᴇʀ ᴜsᴇʀ ᴡɪᴛʜɪɴ ᴀ sᴘᴇᴄɪғɪᴄ ᴛɪᴍᴇ ᴡɪɴᴅᴏᴡ.
"""
