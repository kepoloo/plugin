...
__MODULE__ = "ꜱᴛɪᴄᴋᴇʀ"
__HELP__ = """
ᴛʜɪs ᴍᴏᴅᴜʟᴇ ᴘʀᴏᴠɪᴅᴇs ᴄᴏᴍᴍᴀɴᴅs ғᴏʀ ɪᴍᴀɢᴇ ᴘʀᴏᴄᴇssɪɴɢ.

- `/upscale` ᴏʀ `/hd`: ᴜᴘsᴄᴀᴇ ᴀɴ ɪᴍᴀɢᴇ.
- `/packkang` ᴏʀ `/kang`: ᴋᴀɴɢ sᴛɪᴄᴋᴇʀs ғʀᴏᴍ ᴏᴛʜᴇʀ sᴛɪᴄᴋᴇʀ ᴘᴀᴄᴋs.
- `/stickerid` ᴏʀ `/stid`: ɢᴇᴛ ɪɴғᴏʀᴍᴀᴛɪᴏɴ ᴀʙᴏᴜᴛ ᴀ sᴛɪᴄᴋᴇʀ.
"""
