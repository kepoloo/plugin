...
__MODULE__ = "ꜱᴛɪᴄᴋᴇʀ"
__HELP__ = """
Tʜɪs ᴍᴏᴅᴜʟᴇ ᴘʀᴏᴠɪᴅᴇs ᴄᴏᴍᴍᴀɴᴅs ғᴏʀ ɪᴍᴀɢᴇ ᴘʀᴏᴄᴇssɪɴɢ.

- `/upscale` ᴏʀ `/hd`: Uᴘsᴄᴀᴇ ᴀɴ ɪᴍᴀɢᴇ.
- `/packkang` ᴏʀ `/kang`: Kᴀɴɢ sᴛɪᴄᴋᴇʀs ғʀᴏᴍ ᴏᴛʜᴇʀ sᴛɪᴄᴋᴇʀ ᴘᴀᴄᴋs.
- `/stickerid` ᴏʀ `/stid`: Gᴇᴛ ɪɴғᴏʀᴍᴀᴛɪᴏɴ ᴀʙᴏᴜᴛ ᴀ sᴛɪᴄᴋᴇʀ.
"""
