...
### 1. /getthumb ᴏʀ /ɢgenthumb ᴏʀ /thumb ᴏʀ /thumbai
**Dᴇsᴄʀɪᴘᴛɪᴏɴ:**
Fᴇᴛᴄʜᴇs ᴛʜᴇ ᴛʜᴜᴍʙɴᴀɪʟ ᴏғ ᴀ YᴏᴜTᴜʙᴇ ᴠɪᴅᴇᴏ.

**Usᴀɢᴇ:**
/getthumb [YᴏᴜTᴜʙᴇ_ᴠɪᴅᴇᴏ_URL]

**Dᴇᴛᴀʟɪs:**
- Rᴇᴛʀɪᴇᴠᴇs ᴛʜᴇ ᴛʜᴜᴍʙɴᴀɪʟ ᴏғ ᴛʜᴇ sᴘᴇᴄɪғɪᴇᴅ YᴏᴜTᴜʙᴇ ᴠɪᴅᴇᴏ.
- Pʀᴏᴠɪᴅᴇs ᴛʜᴇ ᴠɪᴅᴇᴏ ᴛɪᴛʟᴇ ᴀs ᴀ ᴄᴀᴘᴛɪᴏɴ ᴡɪᴛʜ ᴀ ʟɪɴᴋ ᴛᴏ ᴛʜᴇ ʙᴏᴛ's ɪɴғᴏ.
- Sᴜᴘᴘᴏʀᴛs ʙᴏᴛʜ sʜᴏʀᴛ ᴀɴᴅ ғᴜɴ YᴏᴜTᴜʙᴇ ᴠɪᴅᴇᴏ URLs.
