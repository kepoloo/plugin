...
Tʜɪs ᴄᴏᴍᴍᴀɴᴅ ᴀʟʟᴏᴡs ᴜsᴇʀs ᴛᴏ sᴇᴀʀᴄʜ ғᴏʀ ɪᴍᴀɢᴇs ᴏɴ Pɪɴᴛᴇʀᴇsᴛ ᴀɴᴅ sᴇɴᴅs ᴀ ᴄᴏᴇᴄᴛɪᴏɴ ᴏғ ᴜᴘ ᴛᴏ 6 ɪᴍᴀɢᴇs.

Fᴇᴀᴛᴜʀᴇs:
- Rᴇᴘʟʏ ᴛᴏ ᴛʜᴇ ᴄᴏᴍᴍᴀɴᴅ ᴡɪᴛʜ ᴀ ǫᴜᴇʀʏ ᴛᴏ sᴇᴀʀᴄʜ ғᴏʀ ɪᴍᴀɢᴇs ʀᴇᴀᴛᴇᴅ ᴛᴏ ᴛʜᴀᴛ ǫᴜᴇʀʏ ᴏɴ Pɪɴᴛᴇʀᴇsᴛ.
- Sᴇɴᴅs ᴜᴘ ᴛᴏ 6 ɪᴍᴀɢᴇs ғᴏᴜɴᴅ ᴏɴ Pɪɴᴛᴇʀᴇsᴛ ʀᴇᴀᴛᴇᴅ ᴛᴏ ᴛʜᴇ ǫᴜᴇʀʏ.

Cᴏᴍᴍᴀɴᴅs:
- /imag <ǫᴜᴇʀʏ>: Sᴇᴀʀᴄʜ ғᴏʀ ɪᴍᴀɢᴇs ʀᴇʟᴀᴛᴇᴅ ᴛᴏ ᴛʜᴇ ᴘʀᴏᴠɪᴅᴇᴅ ǫᴜᴇʀʏ ᴏɴ Pɪɴᴛᴇʀᴇsᴛ.
