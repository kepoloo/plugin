...
### 1. /sʜᴏʀᴛs
**Dᴇsᴄʀɪᴘᴛɪᴏɴ:**
Dᴏᴡɴʟᴏᴀᴅs ᴀ YᴏᴜTᴜʙᴇ ᴠɪᴅᴇᴏ ᴀɴᴅ sᴇɴᴅs ɪᴛ ᴀs ᴀ ʀᴇᴘʏ.

**Usᴀɢᴇ:**
/shorts [YᴏᴜTᴜʙᴇ_ᴠɪᴅᴇᴏ_URL]

**Dᴇᴛᴀɪʟs:**
- Dᴏᴡɴʟᴏᴀᴅs ᴛʜᴇ sᴘᴇᴄɪғɪᴇᴅ YᴏᴜTᴜʙᴇ ᴠɪᴅᴇᴏ ᴀɴᴅ sᴇɴᴅs ɪᴛ ᴀs ᴀ ʀᴇᴘʟʏ.
- Sᴜᴘᴘᴏʀᴛs sʜᴏʀᴛ YᴏᴜTᴜʙᴇ ᴠɪᴅᴇᴏ URLs.
- Aᴜᴛᴏᴍᴀᴛɪᴄʟʏ ᴅᴇᴛᴇᴄᴛs sᴘᴀᴍ ᴀɴᴅ ʟɪᴍɪᴛs ᴇxᴄᴇssɪᴠᴇ ᴜsᴀɢᴇ.

## YᴏᴜTᴜʙᴇ Mᴜsɪᴄ Cᴏᴍᴍᴀɴᴅ Hᴇʟᴘ

### 1. /ʏᴛ ᴏʀ /ᴠɪᴅᴇᴏ
**Dᴇsᴄʀɪᴘᴛɪᴏɴ:**
Sᴇᴀʀᴄʜᴇs YᴏᴜTᴜʙᴇ ғᴏʀ ᴀ ᴠɪᴅᴇᴏ ᴀɴᴅ sᴇɴᴅs ɪᴛ ᴀs ᴀ ʀᴇᴘʟʏ.

**Usᴀɢᴇ:**
/yt [sᴇᴀʀᴄʜ_ǫᴜᴇʀʏ]

**Dᴇᴛᴀɪʟs:**
- Sᴇᴀʀᴄʜᴇs YᴏᴜTᴜʙᴇ ғᴏʀ ᴛʜᴇ sᴘᴇᴄɪғɪᴇᴅ ǫᴜᴇʀʏ ᴀɴᴅ sᴇɴᴅs ᴛʜᴇ ᴠɪᴅᴇᴏ ᴀs ᴀ ʀᴇᴘʟʏ.
- Aᴜᴛᴏᴍᴀᴛɪᴄʟʏ ᴅᴇᴛᴇᴄᴛs sᴘᴀᴍ ᴀɴᴅ ɪᴍɪᴛs ᴇxᴄᴇssɪᴠᴇ ᴜsᴀɢᴇ.
- Pʀᴏᴠɪᴅᴇs ɪɴғᴏʀᴍᴀᴛɪᴏɴ ᴀʙᴏᴜᴛ ᴛʜᴇ ᴠɪᴅᴇᴏ ᴛɪᴛʟᴇ, ᴄʜᴀɴɴᴇʟ, ᴀɴᴅ sᴇᴀʀᴄʜ ǫᴜᴇʀʏ.
"""
