...
**ᴅᴇᴛᴀɪʟs:**
- ғᴇᴛᴄʜᴇs ɪɴғᴏʀᴍᴀᴛɪᴏɴ ᴀʙᴏᴜᴛ ᴛʜᴇ sᴘᴇᴄɪғɪᴇᴅ ᴍᴏᴠɪᴇ ғʀᴏᴍ ᴛʜᴇ TMDʙ API.
- ᴘʀᴏᴠɪᴅᴇs ᴅᴇᴛᴀɪʟs sᴜᴄʜ ᴀs ᴛɪᴛʟᴇ, ʀᴇʟᴇᴀsᴇ ᴅᴀᴛᴇ, ᴏᴠᴇʀᴠɪᴇᴡ, ᴀᴄᴛᴏʀs, ᴠᴏᴛᴇ ᴀᴠᴇʀᴀɢᴇ, ᴛᴏᴛᴀ ᴄᴏʟᴇᴄᴛɪᴏɴ, ᴀɴᴅ ᴀᴠᴀɪʟᴀʙʟᴇ ᴘʟᴀᴛғᴏʀᴍs.
- ᴀᴄᴄᴇssɪʙᴇʟ ʙʏ ᴘʀᴏᴠɪᴅɪɴɢ ᴀ ᴍᴏᴠɪᴇ ɴᴀᴍᴇ ᴀғᴛᴇʀ ᴛʜᴇ ᴄᴏᴍᴍᴀɴᴅ.
- ʜᴇʟᴘs ᴜsᴇʀs ᴅɪsᴄᴏᴠᴇʀ ᴅᴇᴛᴀɪʟs ᴀʙᴏᴜᴛ ᴍᴏᴠɪᴇs ᴏғ ɪɴᴛᴇʀᴇsᴛ.

**ᴇxᴀᴍᴘʟᴇs:**
- `/ᴍᴏᴠɪᴇ ᴛʜᴇ ᴅᴀʀᴋ ᴋɴɪɢʜᴛ`
- `/ᴍᴏᴠɪᴇ ɪɴᴄᴇᴘᴛɪᴏɴ`
"""
