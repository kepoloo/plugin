...
- Pʀᴏᴠɪᴅᴇs ᴅᴇᴛᴀɪs sᴜᴄʜ ᴀs ᴛɪᴛᴇ, ʀᴇᴇᴀsᴇ ᴅᴀᴛᴇ, ᴏᴠᴇʀᴠɪᴇᴡ, ᴀᴄᴛᴏʀs, ᴠᴏᴛᴇ ᴀᴠᴇʀᴀɢᴇ, ᴛᴏᴛᴀ ᴄᴏᴇᴄᴛɪᴏɴ, ᴀɴᴅ ᴀᴠᴀɪʟᴀʙᴇ ᴘʟᴀᴛғᴏʀᴍs.
- Aᴄᴄᴇssɪʙᴇʟ ʙʏ ᴘʀᴏᴠɪᴅɪɴɢ ᴀ ᴍᴏᴠɪᴇ ɴᴀᴍᴇ ᴀғᴛᴇʀ ᴛʜᴇ ᴄᴏᴍᴍᴀɴᴅ.
- Hᴇᴘs ᴜsᴇʀs ᴅɪsᴄᴏᴠᴇʀ ᴅᴇᴛᴀɪʟs ᴀʙᴏᴜᴛ ᴍᴏᴠɪᴇs ᴏғ ɪɴᴛᴇʀᴇsᴛ.
