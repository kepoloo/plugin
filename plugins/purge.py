...
ᴛʜɪs ᴍᴏᴅᴜʟᴇ ᴀʟʟᴏᴡs ᴀᴅᴍɪɴɪsᴛʀᴀᴛᴏʀs ᴛᴏ ᴅᴇʟᴇᴛᴇ ᴍᴜʟᴛɪᴘʟᴇ ᴍᴇssᴀɢᴇs ɪɴ ᴀ sᴜᴘᴇʀɢʀᴏᴜᴘ ᴀᴛ ᴏɴᴄᴇ.

ᴄᴏᴍᴍᴀɴᴅs:
- /purge: ᴅᴇʟᴇᴛᴇs ᴀ ᴍᴇssᴀɢᴇs ʙᴇᴛᴡᴇᴇɴ ᴛʜᴇ ʀᴇᴘɪᴇᴅ ᴍᴇssᴀɢᴇ ᴀɴᴅ ᴛʜᴇ ᴄᴏᴍᴍᴀɴᴅ ᴍᴇssᴀɢᴇ.
- /spurge: ᴅᴇʟᴇᴛᴇs ᴀ ᴍᴇssᴀɢᴇs ʙᴇᴛᴡᴇᴇɴ ᴛʜᴇ ʀᴇᴘɪᴇᴅ ᴍᴇssᴀɢᴇ ᴀɴᴅ ᴛʜᴇ ᴄᴏᴍᴍᴀɴᴅ ᴍᴇssᴀɢᴇ sɪᴇɴᴛʏ (ᴡɪᴛʜᴏᴜᴛ ᴀ ᴛʀᴀᴄᴇ).
- /del: ᴅᴇʟᴇᴛᴇs ᴛʜᴇ ʀᴇᴘʟɪᴇᴅ ᴍᴇssᴀɢᴇ.

ɴᴏᴛᴇ:
- ᴏɴʟʏ ᴀᴠᴀɪʟᴀʙʟᴇ ɪɴ sᴜᴘᴇʀɢʀᴏᴜᴘs.
