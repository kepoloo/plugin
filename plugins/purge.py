...
Tʜɪs ᴍᴏᴅᴜʟᴇ ᴀʟʟᴏᴡs ᴀᴅᴍɪɴɪsᴛʀᴀᴛᴏʀs ᴛᴏ ᴅᴇʟᴇᴛᴇ ᴍᴜʟᴛɪᴘʟᴇ ᴍᴇssᴀɢᴇs ɪɴ ᴀ sᴜᴘᴇʀɢʀᴏᴜᴘ ᴀᴛ ᴏɴᴄᴇ.

Cᴏᴍᴍᴀɴᴅs:
- /purge: Dᴇʟᴇᴛᴇs ᴀ ᴍᴇssᴀɢᴇs ʙᴇᴛᴡᴇᴇɴ ᴛʜᴇ ʀᴇᴘɪᴇᴅ ᴍᴇssᴀɢᴇ ᴀɴᴅ ᴛʜᴇ ᴄᴏᴍᴍᴀɴᴅ ᴍᴇssᴀɢᴇ.
- /spurge: Dᴇʟᴇᴛᴇs ᴀ ᴍᴇssᴀɢᴇs ʙᴇᴛᴡᴇᴇɴ ᴛʜᴇ ʀᴇᴘɪᴇᴅ ᴍᴇssᴀɢᴇ ᴀɴᴅ ᴛʜᴇ ᴄᴏᴍᴍᴀɴᴅ ᴍᴇssᴀɢᴇ sɪᴇɴᴛʏ (ᴡɪᴛʜᴏᴜᴛ ᴀ ᴛʀᴀᴄᴇ).
- /de: Dᴇʟᴇᴛᴇs ᴛʜᴇ ʀᴇᴘʟɪᴇᴅ ᴍᴇssᴀɢᴇ.

Nᴏᴛᴇ:
- Oɴʟʏ ᴀᴠᴀɪʟᴀʙʟᴇ ɪɴ sᴜᴘᴇʀɢʀᴏᴜᴘs.
