...
ᴛʜɪs ᴍᴏᴅᴜʟᴇ ᴘʀᴏᴠɪᴅᴇs ᴠᴀʀɪᴏᴜs ᴄᴏᴍᴍᴀɴᴅs ғᴏʀ ᴍᴀɴᴀɢɪɴɢ ɢʀᴏᴜᴘs.

ᴄᴏᴍᴍᴀɴᴅs:
- /pin: ᴘɪɴ ᴀ ᴍᴇssᴀɢᴇ ɪɴ ᴛʜᴇ ɢʀᴏᴜᴘ.
- /pinned: ᴠɪᴇᴡ ᴛʜᴇ ᴀᴛᴇsᴛ ᴘɪɴɴᴇᴅ ᴍᴇssᴀɢᴇ ɪɴ ᴛʜᴇ ɢʀᴏᴜᴘ.
- /unpin: ᴜɴᴘɪɴ ᴀ ᴍᴇssᴀɢᴇ ɪɴ ᴛʜᴇ ɢʀᴏᴜᴘ.
- /removephoto: ʀᴇᴍᴏᴠᴇ ᴛʜᴇ ɢʀᴏᴜᴘ's ᴘʀᴏғɪᴇ ᴘʜᴏᴛᴏ.
...
- /leavegroup: ᴍᴀᴋᴇ ᴛʜᴇ ʙᴏᴛ ᴇᴀᴠᴇ ᴛʜᴇ ɢʀᴏᴜᴘ.

ɴᴏᴛᴇ:
- ᴏɴʟʏ sᴜᴅᴏ ᴜsᴇʀs ᴀɴᴅ ᴀᴅᴍɪɴs ᴄᴀɴ ᴜsᴇ ᴛʜᴇsᴇ ᴄᴏᴍᴍᴀɴᴅs.
"""
