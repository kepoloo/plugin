...
Tʜɪs ᴍᴏᴅᴜʟᴇ ᴘʀᴏᴠɪᴅᴇs ᴠᴀʀɪᴏᴜs ᴄᴏᴍᴍᴀɴᴅs ғᴏʀ ᴍᴀɴᴀɢɪɴɢ ɢʀᴏᴜᴘs.

Cᴏᴍᴍᴀɴᴅs:
- /pin: Pɪɴ ᴀ ᴍᴇssᴀɢᴇ ɪɴ ᴛʜᴇ ɢʀᴏᴜᴘ.
- /pinned: Vɪᴇᴡ ᴛʜᴇ ᴀᴛᴇsᴛ ᴘɪɴɴᴇᴅ ᴍᴇssᴀɢᴇ ɪɴ ᴛʜᴇ ɢʀᴏᴜᴘ.
- /unpin: Uɴᴘɪɴ ᴀ ᴍᴇssᴀɢᴇ ɪɴ ᴛʜᴇ ɢʀᴏᴜᴘ.
- /removephoto: Rᴇᴍᴏᴠᴇ ᴛʜᴇ ɢʀᴏᴜᴘ's ᴘʀᴏғɪᴇ ᴘʜᴏᴛᴏ.
- /setphoto: Sᴇᴛ ᴀ ɴᴇᴡ ᴘʀᴏғɪᴇ ᴘʜᴏᴛᴏ ғᴏʀ ᴛʜᴇ ɢʀᴏᴜᴘ.
- /settitle: Sᴇᴛ ᴀ ɴᴇᴡ ᴛɪᴛᴇ ғᴏʀ ᴛʜᴇ ɢʀᴏᴜᴘ.
- /setdescription: Sᴇᴛ ᴀ ɴᴇᴡ ᴅᴇsᴄʀɪᴘᴛɪᴏɴ ғᴏʀ ᴛʜᴇ ɢʀᴏᴜᴘ.
- /leavegroup: Mᴀᴋᴇ ᴛʜᴇ ʙᴏᴛ ᴇᴀᴠᴇ ᴛʜᴇ ɢʀᴏᴜᴘ.

Nᴏᴛᴇ:
- Oɴʟʏ sᴜᴅᴏ ᴜsᴇʀs ᴀɴᴅ ᴀᴅᴍɪɴs ᴄᴀɴ ᴜsᴇ ᴛʜᴇsᴇ ᴄᴏᴍᴍᴀɴᴅs.
"""
