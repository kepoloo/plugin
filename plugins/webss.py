...
Tʜɪs ᴄᴏᴍᴍᴀɴᴅ ᴀʟʟᴏᴡs ᴜsᴇʀs ᴛᴏ ᴛᴀᴋᴇ ᴀ sᴄʀᴇᴇɴsʜᴏᴛ ᴏғ ᴀ ᴡᴇʙᴘᴀɢᴇ ᴀɴᴅ sᴇɴᴅ ɪᴛ ᴀs ᴀ ᴘʜᴏᴛᴏ.

Fᴇᴀᴛᴜʀᴇs:
- Rᴇᴘʟʏ ᴛᴏ ᴛʜᴇ ᴄᴏᴍᴍᴀɴᴅ ᴡɪᴛʜ ᴀ URL ᴛᴏ ᴛᴀᴋᴇ ᴀ sᴄʀᴇᴇɴsʜᴏᴛ ᴏғ ᴛʜᴀᴛ ᴡᴇʙᴘᴀɢᴇ ᴀɴᴅ sᴇɴᴅ ɪᴛ ᴀs ᴀ ᴘʜᴏᴛᴏ.

Cᴏᴍᴍᴀɴᴅs:
- /webss <ᴜʀ>: Tᴀᴋᴇ ᴀ sᴄʀᴇᴇɴsʜᴏᴛ ᴏғ ᴛʜᴇ ᴘʀᴏᴠɪᴅᴇᴅ URL ᴀɴᴅ sᴇɴᴅ ɪᴛ ᴀs ᴀ ᴘʜᴏᴛᴏ.

Exᴀᴍᴘᴇ:
- /ᴡᴇʙss <ᴜʀ>: Tᴀᴋᴇs ᴀ sᴄʀᴇᴇɴsʜᴏᴛ ᴏғ ᴛʜᴇ ᴘʀᴏᴠɪᴅᴇᴅ URL ᴀɴᴅ sᴇɴᴅs ɪᴛ ᴀs ᴀ ᴘʜᴏᴛᴏ.

Nᴏᴛᴇ: Tʜɪs ᴄᴏᴍᴍᴀɴᴅ ᴜsᴇs ᴀɴ ᴇxᴛᴇʀɴᴀʟ sᴇʀᴠɪᴄᴇ ᴛᴏ ᴛᴀᴋᴇ sᴄʀᴇᴇɴsʜᴏᴛs ᴏғ ᴡᴇʙᴘᴀɢᴇs.
"""
