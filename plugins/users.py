...
__MODULE__ = "ᴜꜱᴇʀꜱ"
__HELP__ = """
/user: Gᴇᴛ ᴀ ʟɪsᴛ ᴏғ ᴀ ᴍᴇᴍʙᴇʀs ɪɴ ᴛʜᴇ ᴄʜᴀᴛ.

Tʜɪs ᴄᴏᴍᴍᴀɴᴅ ɪs ғᴏʀ ᴀᴅᴍɪɴs ᴏɴʏ.

Fᴇᴀᴛᴜʀᴇs:
- Tʀᴀᴄᴋs ᴛʜᴇ ʟᴀsᴛ ᴍᴇssᴀɢᴇ ᴛɪᴍᴇsᴛᴀᴍᴘ ғᴏʀ ᴇᴀᴄʜ ᴜsᴇʀ.
- Pʀᴇᴠᴇɴᴛs ᴄᴏᴍᴍᴀɴᴅ sᴘᴀᴍᴍɪɴɢ ᴡɪᴛʜ ᴀ ᴛʜʀᴇsʜᴏʟᴅ ᴏғ 2 ᴄᴏᴍᴍᴀɴᴅs ᴡɪᴛʜɪɴ 5 sᴇᴄᴏɴᴅs.
- Exᴘᴏʀᴛs ᴛʜᴇ ʟɪsᴛ ᴏғ ᴍᴇᴍʙᴇʀs ᴛᴏ ᴀ CSV ғɪʟᴇ ᴀɴᴅ sᴇɴᴅs ɪᴛ ᴀs ᴀ ᴅᴏᴄᴜᴍᴇɴᴛ.
"""
