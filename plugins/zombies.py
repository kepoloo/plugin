...
Tʜɪs ᴍᴏᴅᴜʟᴇ ᴘʀᴏᴠɪᴅᴇs ᴛᴏᴏʟs ғᴏʀ ɢʀᴏᴜᴘ ᴀᴅᴍɪɴɪsᴛʀᴀᴛᴏʀs ᴛᴏ ᴍᴀɴᴀɢᴇ ᴛʜᴇ ɢʀᴏᴜᴘ ᴇғғᴇᴄᴛɪᴠʟʏ.

### Cᴏᴍᴍᴀɴᴅs:
- `/zombies`: Rᴇᴍᴏᴠᴇ ᴅᴇʟᴇᴛᴇᴅ ᴀᴄᴄᴏᴜɴᴛs ғʀᴏᴍ ᴛʜᴇ ɢʀᴏᴜᴘ.
- `/admins` ᴏʀ `/staff`: Gᴇᴛ ᴀ ɪsᴛ ᴏғ ɢʀᴏᴜᴘ ᴀᴅᴍɪɴɪsᴛʀᴀᴛᴏʀs ᴀɴᴅ ᴏᴡɴᴇʀs.
- `/bots`: Gᴇᴛ ᴀ ʟɪsᴛ ᴏғ ʙᴏᴛs ɪɴ ᴛʜᴇ ɢʀᴏᴜᴘ.

### Fᴇᴀᴛᴜʀᴇs:
- `ᴢᴏᴍʙɪᴇs`: Rᴇᴍᴏᴠᴇs ᴅᴇʟᴇᴛᴇᴅ ᴀᴄᴄᴏᴜɴᴛs ғʀᴏᴍ ᴛʜᴇ ɢʀᴏᴜᴘ.
- `ᴀᴅᴍɪɴs` ᴏʀ `sᴛᴀғғ`: Dɪsᴘʟᴀʏs ᴀ ʟɪsᴛ ᴏғ ɢʀᴏᴜᴘ ᴀᴅᴍɪɴɪsᴛʀᴀᴛᴏʀs ᴀɴᴅ ᴏᴡɴᴇʀs.
- `ʙᴏᴛs`: Dɪsᴘʟᴀʏs ᴀ ʟɪsᴛ ᴏғ ʙᴏᴛs ɪɴ ᴛʜᴇ ɢʀᴏᴜᴘ.
"""
