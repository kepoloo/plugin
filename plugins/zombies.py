...
ᴛʜɪs ᴍᴏᴅᴜʟᴇ ᴘʀᴏᴠɪᴅᴇs ᴛᴏᴏʟs ғᴏʀ ɢʀᴏᴜᴘ ᴀᴅᴍɪɴɪsᴛʀᴀᴛᴏʀs ᴛᴏ ᴍᴀɴᴀɢᴇ ᴛʜᴇ ɢʀᴏᴜᴘ ᴇғғᴇᴄᴛɪᴠʟʏ.

ᴄᴏᴍᴍᴀɴᴅs:
- `/ᴢᴏᴍʙɪᴇs`: ʀᴇᴍᴏᴠᴇ ᴅᴇʟᴇᴛᴇᴅ ᴀᴄᴄᴏᴜɴᴛs ғʀᴏᴍ ᴛʜᴇ ɢʀᴏᴜᴘ.
- `/ᴀᴅᴍɪɴs` ᴏʀ `/sᴛᴀғғ`: ɢᴇᴛ ᴀ ʟɪsᴛ ᴏғ ɢʀᴏᴜᴘ ᴀᴅᴍɪɴɪsᴛʀᴀᴛᴏʀs ᴀɴᴅ ᴏᴡɴᴇʀs.
- `/ʙᴏᴛs`: ɢᴇᴛ ᴀ ʟɪsᴛ ᴏғ ʙᴏᴛs ɪɴ ᴛʜᴇ ɢʀᴏᴜᴘ.

ғᴇᴀᴛᴜʀᴇs:
- `ᴢᴏᴍʙɪᴇs`: ʀᴇᴍᴏᴠᴇs ᴅᴇʟᴇᴛᴇᴅ ᴀᴄᴄᴏᴜɴᴛs ғʀᴏᴍ ᴛʜᴇ ɢʀᴏᴜᴘ.
- `ᴀᴅᴍɪɴs` ᴏʀ `sᴛᴀғғ`: ᴅɪsᴘʟᴀʏs ᴀ ʟɪsᴛ ᴏғ ɢʀᴏᴜᴘ ᴀᴅᴍɪɴɪsᴛʀᴀᴛᴏʀs ᴀɴᴅ ᴏᴡɴᴇʀs.
- `ʙᴏᴛs`: ᴅɪsᴘʟᴀʏs ᴀ ʟɪsᴛ ᴏғ ʙᴏᴛs ɪɴ ᴛʜᴇ ɢʀᴏᴜᴘ.
"""
